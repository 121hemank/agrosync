...
import { Sprout, CloudSun, ShoppingBag, BarChart3, Shield, TrendingUp } from 'lucide-react';
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="px-6 lg:px-12 py-20 lg:py-32 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg text-gray-600 leading-relaxed">
            From crop planning to marketplace selling, AgroSync AI helps farmers make data-driven decisions using AI, weather analytics, and market insights.
          </p>
          <div className="flex gap-4 mt-8">
            <Link to="/register" className="bg-primary text-white px-6 py-3 rounded-lg font-medium hover:bg-primary-700">Start Free</Link>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { icon: BarChart3, title: 'AI Analytics', desc: 'Crop recommendations, harvest predictions, and yield forecasts' },
              { icon: ShoppingBag, title: 'Marketplace', desc: 'Sell directly to buyers without middlemen' },
              { icon: TrendingUp, title: 'Revenue Tracking', desc: 'Track profits, orders, and farm performance' },
              { icon: Shield, title: 'Smart Alerts', desc: 'Get notified about weather changes, orders, and insights' },
              { icon: Sprout, title: 'Crop Planning', desc: 'Plan your crops with AI-powered recommendations' }
            ].map((f, i) => (
      ...
      <footer className="px-6 lg:px-12 py-8 border-t border-gray-200">
        <div className="max-w-7xl mx-auto flex items-center justify-between text-sm text-gray-500">
          <span>&copy; 2026 AgroSync AI. All rights reserved.</span>
