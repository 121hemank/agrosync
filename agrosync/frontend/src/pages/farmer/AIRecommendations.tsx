...
export default function AIRecommendations() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="font-heading text-2xl font-bold">Crop Recommendations</h1>
        <p className="text-gray-500 mt-1">Get crop suggestions based on your soil and climate</p>
      </div>
